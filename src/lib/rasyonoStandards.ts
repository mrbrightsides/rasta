...
export const RASYONO_BENCHMARK_TIERS: Record<string, RasyonoTierInfo> = {
  GOLD: {
    ...
    fullLabel: 'BAIK SEKALI (≥90%)',
    badgeBg: 'bg-amber-100',
    badgeText: 'text-amber-950',
    badgeBorder: 'border-amber-400',
    badgeGlow: 'ring-2 ring-amber-300',
    icon: '🥇',
    summaryText: 'Performa Elit. Tingkat akurasi eksekusi luar biasa tinggi, memenuhi standar Baik Sekali turnamen nasional/internasional.',
  ...
  SILVER: {
    ...
    medali: 'BAIK',
    predicate: 'BAIK',
    fullLabel: 'BAIK (80-89%)',
    badgeBg: 'bg-slate-100',
    badgeText: 'text-slate-900',
    badgeBorder: 'border-slate-300',
    badgeGlow: 'ring-1 ring-slate-300',
    icon: '🥈',
    summaryText: 'Performa Sangat Kompetitif. Akurasi konsisten memenuhi standar Baik.',
    recommendation: 'Perkuat eksekusi pada jarak kritis (8m-10m) dan tingkatkan persentase tembakan Carreau untuk menembus ambang 90% (Level Baik Sekali).',
  },
  BRONZE: {
    no: 1,
    level: 1,
    ...
    medali: 'CUKUP',
    predicate: 'CUKUP',
    fullLabel: 'CUKUP (70-79%)',
    badgeBg: 'bg-orange-50',
    badgeText: 'text-orange-950',
    badgeBorder: 'border-orange-300',
    badgeGlow: 'ring-1 ring-orange-200',
    icon: '🥉',
    summaryText: 'Performa Cukup. Masuk ke ambang batas standar Cukup.',
  ...
  BELOW_BENCHMARK: {
    ...
    fullLabel: 'DI BAWAH STANDAR (<70%)',
    badgeBg: 'bg-rose-50',
    badgeText: 'text-rose-900',
    badgeBorder: 'border-rose-200',
    badgeGlow: 'ring-1 ring-rose-200',
    icon: '⚠️',
    summaryText: 'Belum mencapai ambang minimal persaingan (70%). Perlu evaluasi menyeluruh pada teknik dasar dan kontrol lemparan.',
